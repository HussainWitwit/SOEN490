...
import DateDialog from "../AddRecommendation/DateDialog";
...
function TemplateDialog(props) {
    const [openFirst, setOpenFirst] = React.useState(props.openDialog);
        ...
        <div>
            <div>
                <Grid id="grid-container1" container spacing={1} className="gridContainerStyle">
                    <Grid item>
                        <Dialog open={openFirst} onClose={props.onCloseDialog} aria-labelledby="form-dialog-title">
                          ...
                          {openSecond ? <DateDialog openDialog={openSecond} onCloseDialog={props.onCloseDialog} /> : <div></div>}
{/* 
