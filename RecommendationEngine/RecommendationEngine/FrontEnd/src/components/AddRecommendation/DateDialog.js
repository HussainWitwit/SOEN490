...
import ParametersDialog from "../AddRecommendation/ParametersDialog";
...
function DateDialog(props) {
    ...
    const [openSecond, setOpenSecond] = React.useState(props.openDialog);
                ...
                <Grid id="grid-container1" container spacing={1} className="gridContainerStyle">
                    <Grid item>
                        ...
                        <Dialog open={openSecond} onClose={props.onCloseDialog} aria-labelledby="form-dialog-title">
                         ...
                         {openThird ? <ParametersDialog openDialog={openThird} onCloseDialog={props.onCloseDialog} /> : <div></div>}
